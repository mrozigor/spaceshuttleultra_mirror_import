...
\section{CHANGE LOG}
\noindent
\textbf{Major changes from SSU 4.0}\\\\
$\rightarrow$ corrected main gear wheel well visibility issue\\
$\rightarrow$ corrected the animation of the SSMEs\\
$\rightarrow$ improved the animation of the ET umbilical doors\\
\\\\
