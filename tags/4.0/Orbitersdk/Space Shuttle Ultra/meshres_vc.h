...
// Date of conversion : Sat May 07 12:36:00 2016
...
const unsigned int GRP_A6GUARD_VC	=	1232;	//A6Guard
const unsigned int GRP_A6US37_VC	=	1233;	//A6US37
const unsigned int GRP_A6US4_VC	=	1234;	//A6US4
const unsigned int GRP_A6URS5_VC	=	1235;	//A6URS5
const unsigned int GRP_A6URS4_VC	=	1236;	//A6URS4
const unsigned int GRP_A6URS3_VC	=	1237;	//A6URS3
const unsigned int GRP_A6URS1_VC	=	1238;	//A6URS1
const unsigned int GRP_A6URS2_VC	=	1239;	//A6URS2
const unsigned int GRP_A6U39_VC	=	1240;	//A6U39
const unsigned int GRP_A6U40_VC	=	1241;	//A6U40
const unsigned int GRP_A6U41_VC	=	1242;	//A6U41
const unsigned int GRP_A6U45_VC	=	1243;	//A6U45
const unsigned int GRP_A6U44_VC	=	1244;	//A6U44
const unsigned int GRP_A6U43_VC	=	1245;	//A6U43
const unsigned int GRP_A6U42_VC	=	1246;	//A6U42
const unsigned int GRP_A6U36_VC	=	1247;	//A6U36
const unsigned int GRP_A6U47_VC	=	1248;	//A6U47
const unsigned int GRP_A6U46_VC	=	1249;	//A6U46
const unsigned int GRP_A6U7_VC	=	1250;	//A6U7
const unsigned int GRP_A6U5_VC	=	1251;	//A6U5
const unsigned int GRP_A6U1_VC	=	1252;	//A6U1
const unsigned int GRP_A6U34_VC	=	1253;	//A6U34
const unsigned int GRP_A6U35_VC	=	1254;	//A6U35
const unsigned int GRP_A6U33_VC	=	1255;	//A6U33
const unsigned int GRP_A6U32_VC	=	1256;	//A6U32
const unsigned int GRP_A6U2_VC	=	1257;	//A6U2
const unsigned int GRP_A6U6_VC	=	1258;	//A6U6
const unsigned int GRP_A6UPANEL_VC	=	1259;	//A6Upanel
const unsigned int GRP_CLOCK8_VC	=	1260;	//Clock8
const unsigned int GRP_CLOCK7_VC	=	1261;	//Clock7
const unsigned int GRP_CLOCK6_VC	=	1262;	//Clock6
const unsigned int GRP_CLOCK5_VC	=	1263;	//Clock5
const unsigned int GRP_A6UTOG1_VC	=	1264;	//A6Utog1
const unsigned int GRP_A6UTOG2_VC	=	1265;	//A6Utog2
const unsigned int GRP_A6UTOG3_VC	=	1266;	//A6Utog3
const unsigned int GRP_A6UTOG4_VC	=	1267;	//A6Utog4
const unsigned int GRP_O6TALKBACK2_VC	=	1268;	//O6talkback2
const unsigned int GRP_O6TALKBACK1_VC	=	1269;	//O6talkback1
const unsigned int GRP_O6TALKBACK3_VC	=	1270;	//O6talkback3
const unsigned int GRP_O6TALKBACK4_VC	=	1271;	//O6talkback4
const unsigned int GRP_O6TALKBACK5_VC	=	1272;	//O6talkback5
const unsigned int GRP_O6TALKBACK6_VC	=	1273;	//O6talkback6
const unsigned int GRP_O6TALKBACK7_VC	=	1274;	//O6talkback7
const unsigned int GRP_O6TALKBACK8_VC	=	1275;	//O6talkback8
const unsigned int GRP_O6TALKBACK9_VC	=	1276;	//O6talkback9
const unsigned int GRP_O6TALKBACK10_VC	=	1277;	//O6talkback10
const unsigned int GRP_O6TALKBACK11_VC	=	1278;	//O6talkback11
const unsigned int GRP_O6TALKBACK12_VC	=	1279;	//O6talkback12
const unsigned int GRP_CCTVMONITORS_VC	=	1280;	//CCTVmonitors
const unsigned int GRP_MON1_VC	=	1281;	//MON1
const unsigned int GRP_MON1SWITCH1_VC	=	1282;	//MON1switch1
const unsigned int GRP_MON1SWITCH2_VC	=	1283;	//MON1switch2
const unsigned int GRP_MON1COLOR_VC	=	1284;	//MON1color
const unsigned int GRP_MON1TINT_VC	=	1285;	//MON1tint
const unsigned int GRP_MON1CONTR_VC	=	1286;	//MON1contr
const unsigned int GRP_MON1BRIGHT_VC	=	1287;	//MON1bright
const unsigned int GRP_MON1SELECTBUTTON_VC	=	1288;	//MON1SELECTbutton
const unsigned int GRP_MON2_VC	=	1289;	//MON2
const unsigned int GRP_MON2SWITCH1_VC	=	1290;	//MON2switch1
const unsigned int GRP_MON2SWITCH2_VC	=	1291;	//MON2switch2
const unsigned int GRP_MON2COLOR_VC	=	1292;	//MON2color
const unsigned int GRP_MON2TINT_VC	=	1293;	//MON2tint
const unsigned int GRP_MON2CONTR_VC	=	1294;	//MON2contr
const unsigned int GRP_MON2BRIGHT_VC	=	1295;	//MON2bright
const unsigned int GRP_MON2SELECTBUTTON_VC	=	1296;	//MON2SELECTbutton
const unsigned int GRP_OVERLAY_VC	=	1297;	//overlay
const unsigned int GRP_CTR_SSME_SHTDN_PB_VC	=	1298;	//CTR_SSME_SHTDN_PB
const unsigned int GRP_LEFT_SSME_SHTDN_PB_VC	=	1299;	//LEFT_SSME_SHTDN_PB
const unsigned int GRP_RIGHT_SSME_SHTDN_PB_VC	=	1300;	//RIGHT_SSME_SHTDN_PB
const unsigned int GRP_SRB_SEP_PB_VC	=	1301;	//SRB_SEP_PB
const unsigned int GRP_DAP_A_PB_VC	=	1302;	//DAP_A_PB
const unsigned int GRP_DAP_ALT_PB_VC	=	1303;	//DAP_ALT_PB
const unsigned int GRP_DAP_AUTO_PB_VC	=	1304;	//DAP_AUTO_PB
const unsigned int GRP_DAP_B_PB_VC	=	1305;	//DAP_B_PB
const unsigned int GRP_DAP_BLANK_VC	=	1306;	//DAP_BLANK
const unsigned int GRP_DAP_FREE_PB_VC	=	1307;	//DAP_FREE_PB
const unsigned int GRP_DAP_HIGH_Z_PB_VC	=	1308;	//DAP_HIGH_Z_PB
const unsigned int GRP_DAP_INRTL_PB_VC	=	1309;	//DAP_INRTL_PB
const unsigned int GRP_DAP_LOW_Z_PB_VC	=	1310;	//DAP_LOW_Z_PB
const unsigned int GRP_DAP_LVLH_PB_VC	=	1311;	//DAP_LVLH_PB
const unsigned int GRP_DAP_PITCH_DISC_RATE_PB_VC	=	1312;	//DAP_PITCH_DISC_RATE_PB
const unsigned int GRP_DAP_PITCH_PULSE_PB_VC	=	1313;	//DAP_PITCH_PULSE_PB
const unsigned int GRP_DAP_PRI_PB_VC	=	1314;	//DAP_PRI_PB
const unsigned int GRP_DAP_ROL_DISC_RATE_PB_VC	=	1315;	//DAP_ROL_DISC_RATE_PB
const unsigned int GRP_DAP_ROLL_PULSE_PB_VC	=	1316;	//DAP_ROLL_PULSE_PB
const unsigned int GRP_DAP_VERN_PB_VC	=	1317;	//DAP_VERN_PB
const unsigned int GRP_DAP_X_NORM_PB_VC	=	1318;	//DAP_X_NORM_PB
const unsigned int GRP_DAP_X_PULSE_PB_VC	=	1319;	//DAP_X_PULSE_PB
const unsigned int GRP_DAP_Y_NORM_PB_VC	=	1320;	//DAP_Y_NORM_PB
const unsigned int GRP_DAP_Y_PULSE_PB_VC	=	1321;	//DAP_Y_PULSE_PB
const unsigned int GRP_DAP_YAW_DISC_RATE_PB_VC	=	1322;	//DAP_YAW_DISC_RATE_PB
const unsigned int GRP_DAP_YAW_PULSE_PB_VC	=	1323;	//DAP_YAW_PULSE_PB
const unsigned int GRP_DAP_Z_NORM_PB_VC	=	1324;	//DAP_Z_NORM_PB
const unsigned int GRP_DAP_Z_PULSE_PB_VC	=	1325;	//DAP_Z_PULSE_PB
const unsigned int GRP_ET_SEP_PB_VC	=	1326;	//ET_SEP_PB
const unsigned int GRP_CW_AC_OVERLOAD_VC	=	1327;	//CW_AC_OVERLOAD
const unsigned int GRP_CW_AC_VOLTAGE_VC	=	1328;	//CW_AC_VOLTAGE
const unsigned int GRP_CW_AIR_DATA_VC	=	1329;	//CW_AIR_DATA
const unsigned int GRP_CW_APU_OVERSPEED_VC	=	1330;	//CW_APU_OVERSPEED
const unsigned int GRP_CW_APU_TEMP_VC	=	1331;	//CW_APU_TEMP
const unsigned int GRP_CW_APU_UNDERSPEED_VC	=	1332;	//CW_APU_UNDERSPEED
const unsigned int GRP_CW_AV_BAY_CABIN_AIR_VC	=	1333;	//CW_AV_BAY_CABIN_AIR
const unsigned int GRP_CW_BACKUP_CW_ALARM_VC	=	1334;	//CW_BACKUP_CW_ALARM
const unsigned int GRP_CW_BLANK_VC	=	1335;	//CW_BLANK
const unsigned int GRP_CW_BLANK2_VC	=	1336;	//CW_BLANK2
const unsigned int GRP_CW_CABIN_ATM_VC	=	1337;	//CW_CABIN_ATM
const unsigned int GRP_CW_FCS_CHANNEL_VC	=	1338;	//CW_FCS_CHANNEL
const unsigned int GRP_CW_FCS_SATURATION_VC	=	1339;	//CW_FCS_SATURATION
const unsigned int GRP_CW_FREON_LOOP_VC	=	1340;	//CW_FREON_LOOP
const unsigned int GRP_CW_FUEL_CELL_PUMP_VC	=	1341;	//CW_FUEL_CELL_PUMP
const unsigned int GRP_CW_FUEL_CELL_REAC_VC	=	1342;	//CW_FUEL_CELL_REAC
const unsigned int GRP_CW_FUEL_CELL_STACK_TEMP_VC	=	1343;	//CW_FUEL_CELL_STACK_TEMP
const unsigned int GRP_CW_FWD_RCS_VC	=	1344;	//CW_FWD_RCS
const unsigned int GRP_CW_GPC_VC	=	1345;	//CW_GPC
const unsigned int GRP_CW_H20_LOOP_VC	=	1346;	//CW_H20_LOOP
const unsigned int GRP_CW_H2_PRESS_VC	=	1347;	//CW_H2_PRESS
const unsigned int GRP_CW_HYD_PRESS_VC	=	1348;	//CW_HYD_PRESS
const unsigned int GRP_CW_IMU_VC	=	1349;	//CW_IMU
const unsigned int GRP_CW_LEFT_OMS_VC	=	1350;	//CW_LEFT_OMS
const unsigned int GRP_CW_LEFT_RCS_VC	=	1351;	//CW_LEFT_RCS
const unsigned int GRP_CW_LEFT_RHC_VC	=	1352;	//CW_LEFT_RHC
const unsigned int GRP_CW_MAIN_BUS_UNDERVOLT_VC	=	1353;	//CW_MAIN_BUS_UNDERVOLT
const unsigned int GRP_CW_MPS_VC	=	1354;	//CW_MPS
const unsigned int GRP_CW_O2_HEATER_TEMP_VC	=	1355;	//CW_O2_HEATER_TEMP
const unsigned int GRP_CW_O2_PRESS_VC	=	1356;	//CW_O2_PRESS
const unsigned int GRP_CW_OMS_KIT_VC	=	1357;	//CW_OMS_KIT
const unsigned int GRP_CW_OMS_TVC_VC	=	1358;	//CW_OMS_TVC
const unsigned int GRP_CW_PAYLOAD_CAUTION_VC	=	1359;	//CW_PAYLOAD_CAUTION
const unsigned int GRP_CW_PAYLOAD_WARNING_VC	=	1360;	//CW_PAYLOAD_WARNING
const unsigned int GRP_CW_PRIMARY_CW_VC	=	1361;	//CW_PRIMARY_CW
const unsigned int GRP_CW_RCS_JET_VC	=	1362;	//CW_RCS_JET
const unsigned int GRP_CW_RGA_ACCEL_VC	=	1363;	//CW_RGA_ACCEL
const unsigned int GRP_CW_RIGHT_AFT_RHC_VC	=	1364;	//CW_RIGHT_AFT_RHC
const unsigned int GRP_CW_RIGHT_OMS_VC	=	1365;	//CW_RIGHT_OMS
const unsigned int GRP_CW_RIGHT_RCS_VC	=	1366;	//CW_RIGHT_RCS
...
const unsigned int GRP_A1U_TB_SCANWARN_VC	=	1372;	//A1U_TB_SCANWARN
const unsigned int GRP_A1U_TB_TRACK_VC	=	1373;	//A1U_TB_TRACK
const unsigned int GRP_A1U_TB_SEARCH_VC	=	1374;	//A1U_TB_SEARCH
const unsigned int GRP_A1_SHADOW_VC	=	1375;	//A1 shadow
