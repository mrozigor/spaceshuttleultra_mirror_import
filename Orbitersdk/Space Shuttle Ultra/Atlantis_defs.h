...
const static char* DEFAULT_MESHNAME_PANELF9 = "SSU\\panelF9";
const static char* DEFAULT_MESHNAME_PANELC3 = "SSU\\panelC3";
const static char* DEFAULT_MESHNAME_PANELO1 = "SSU\\panelO1";
const static char* DEFAULT_MESHNAME_PANELO2 = "SSU\\panelO2";
const static char* DEFAULT_MESHNAME_PANELO3 = "SSU\\panelO3";
const static char* DEFAULT_MESHNAME_PANELO5 = "SSU\\panelO5";
const static char* DEFAULT_MESHNAME_PANELO6 = "SSU\\panelO6";
const static char* DEFAULT_MESHNAME_PANELO7 = "SSU\\panelO7";
const static char* DEFAULT_MESHNAME_PANELO8 = "SSU\\panelO8";
const static char* DEFAULT_MESHNAME_PANELO9 = "SSU\\panelO9";
const static char* DEFAULT_MESHNAME_PANELO13 = "SSU\\panelO13";
const static char* DEFAULT_MESHNAME_PANELO17 = "SSU\\panelO17";
const static char* DEFAULT_MESHNAME_PANELA2 = "SSU\\panelA2";
const static char* DEFAULT_MESHNAME_PANELA4 = "SSU\\panelA4";
const static char* DEFAULT_MESHNAME_PANELA6U = "SSU\\panelA6U";
const static char* DEFAULT_MESHNAME_PANELA7U = "SSU\\panelA7U";
const static char* DEFAULT_MESHNAME_PANELA8 = "SSU/RMSVC";
const static char* DEFAULT_MESHNAME_PANELL1 = "SSU\\panelL1";
const static char* DEFAULT_MESHNAME_PANELL2 = "SSU\\panelL2";
const static char* DEFAULT_MESHNAME_PANELL4 = "SSU\\panelL4";
const static char* DEFAULT_MESHNAME_PANELL9 = "SSU\\panelL9";
const static char* DEFAULT_MESHNAME_PANELL10_IUS = "SSU\\panelL10_IUS";
const static char* DEFAULT_MESHNAME_PANELL12U_CENTAUR = "SSU\\panelL12U_SSP_Centaur";
const static char* DEFAULT_MESHNAME_PANELL12U_IUS = "SSU\\panelL12U_SSP_IUS";
const static char* DEFAULT_MESHNAME_PANELR1 = "SSU\\panelR1";
const static char* DEFAULT_MESHNAME_PANELR2 = "SSU\\panelR2";
const static char* DEFAULT_MESHNAME_PANELR4 = "SSU\\panelR4";
const static char* DEFAULT_MESHNAME_PANELR10 = "SSU\\panelR10";
const static char* DEFAULT_MESHNAME_PANELR13U = "SSU\\panelR13U";
...
const VECTOR3 ET_OFFSET = _V(0.0, -9.0, 4.480); // offset between ET and shuttle meshes
...
//SSME REF are gimbal points
const VECTOR3 SSMER_REF = _V(1.3462, -1.733744, -12.875018); //Xo1468.17 Yo53 Zo342.64
const VECTOR3 SSMEL_REF = _V(-1.3462, -1.733744, -12.875018);//Xo1468.17 Yo-53 Zo342.64
const VECTOR3 SSMET_REF = _V(0.0, 0.8154, -12.2865); //Xo1445 Yo0 Z443
...
// ============================================================
const double PLBD_MOTOR_RANGE = 94.0 * RAD;// tunes how much the doors open

const VECTOR3 PLBD_PORT_AXIS = _V( 0.0, 0.0, -1.0 );
const VECTOR3 PLBD_PORT_P1 = _V( -2.4183, 0.2548, 0.0 );// clamp/pull rod axis
const VECTOR3 PLBD_PORT_P2 = _V( -2.6129, 0.2914, 0.0 );// pull rod/door axis
const VECTOR3 PLBD_PORT_P3 = _V( -2.7000, 0.2350, 0.0 );// door axis
const VECTOR3 PLBD_PORT_P4 = _V( -2.6343, 0.1333, 0.0 );// clamp axis
const VECTOR3 PLBD_PORT_P5 = _V( -2.5658, 0.0383, 0.0 );// push rod/clamp axis
const VECTOR3 PLBD_PORT_P6 = _V( -2.5781, -0.2404, 0.0 );// motor/push rod axis
const VECTOR3 PLBD_PORT_P7 = _V( -2.5172, -0.1508, 0.0 );// motor axis

const VECTOR3 PLBD_STBD_AXIS = _V( 0.0, 0.0, 1.0 );
const VECTOR3 PLBD_STBD_P1 = _V( 2.4183, 0.2548, 0.0 );// clamp/pull rod axis
const VECTOR3 PLBD_STBD_P2 = _V( 2.6129, 0.2914, 0.0 );// pull rod/door axis
const VECTOR3 PLBD_STBD_P3 = _V( 2.7000, 0.2350, 0.0 );// door axis
const VECTOR3 PLBD_STBD_P4 = _V( 2.6343, 0.1333, 0.0 );// clamp axis
const VECTOR3 PLBD_STBD_P5 = _V( 2.5658, 0.0383, 0.0 );// push rod/clamp axis
const VECTOR3 PLBD_STBD_P6 = _V( 2.5781, -0.2404, 0.0 );// motor/push rod axis
const VECTOR3 PLBD_STBD_P7 = _V( 2.5172, -0.1508, 0.0 );// motor axis
