...
const VECTOR3 ET_OFFSET = _V(0.0, -9.82, 3.51); // offset between ET and shuttle meshes
const VECTOR3 LSRB_OFFSET = _V(-6.4, -9.75, 1.13); // offset between SRB and shuttle mesh
...
const VECTOR3 POS_HDP = _V(0.0, -9.75, -19.07);
