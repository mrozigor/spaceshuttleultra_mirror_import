...
namespace vc
{
	...
	void PanelL1::DefineVC( void )
	{
		...
		pFireSuppressionAvBayDischAgentCover[0]->DefineCoverGroup( GRP_L1COVER1_VC );
		...
		pFireSuppressionAvBayDischAgentCover[1]->DefineCoverGroup( GRP_L1COVER2_VC );
		...
		pFireSuppressionAvBayDischAgentCover[2]->DefineCoverGroup( GRP_L1COVER3_VC );
		...
		pFireSuppressionAvBayDischAgent[0]->DefineMeshGroup( STS()->mesh_vc, GRP_L1_S4_VC );
		...
		pFireSuppressionAvBayDischAgent[1]->DefineMeshGroup( STS()->mesh_vc, GRP_L1_S5_VC );
		...
		pFireSuppressionAvBayDischAgent[2]->DefineMeshGroup( STS()->mesh_vc, GRP_L1_S6_VC );

		pSmokeDetectionA_Cabin->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_A_CABIN_VC );
		pSmokeDetectionA_Cabin->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionA_LFltDeck->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_A_LFLTDECK_VC );
		pSmokeDetectionA_LFltDeck->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionA_AvBay1->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_A_AVBAY1_VC );
		pSmokeDetectionA_AvBay1->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionA_AvBay2->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_A_AVBAY2_VC );
		pSmokeDetectionA_AvBay2->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionA_AvBay3->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_A_AVBAY3_VC );
		pSmokeDetectionA_AvBay3->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionB_Payload->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_B_PAYLOAD_VC );
		pSmokeDetectionB_Payload->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionB_RFltDeck->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_B_RFLTDECK_VC );
		pSmokeDetectionB_RFltDeck->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionB_AvBay1->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_B_AVBAY1_VC );
		pSmokeDetectionB_AvBay1->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionB_AvBay2->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_B_AVBAY2_VC );
		pSmokeDetectionB_AvBay2->SetStateOffset( 1, 0.0f, -0.232910f );

		pSmokeDetectionB_AvBay3->DefineMeshGroup( STS()->mesh_vc, GRP_L1_XDS1_B_AVBAY3_VC );
