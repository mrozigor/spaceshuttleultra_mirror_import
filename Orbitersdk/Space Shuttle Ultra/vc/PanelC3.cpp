...
namespace vc
{
	...
	void PanelC3::DefineVC()
	{
		...
		pAirDataProbeStowEnable[LEFT]->SetMouseRegion( AID_C3, 0.063720f, 0.255919f, 0.126235f, 0.321174f);
		...
		pAirDataProbeStowEnable[RIGHT]->SetMouseRegion( AID_C3, 0.126235f, 0.255919f, 0.189637f, 0.321174f);		
		...
		pAirDataProbeDeploy[LEFT]->SetMouseRegion( AID_C3, 0.080556f, 0.753680f, 0.148883f, 0.864232f);
		...
		pAirDataProbeDeploy[RIGHT]->SetMouseRegion( AID_C3, 0.148883f, 0.753680f, 0.208679f, 0.864232f);		
