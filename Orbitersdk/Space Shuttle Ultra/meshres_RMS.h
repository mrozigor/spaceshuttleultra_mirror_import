...
const unsigned int GRP_ELBOW_CAM	=	2;	//ELBOW_CAM
const unsigned int GRP_ELBOW_CAM_BASE	=	3;	//ELBOW_CAM_BASE
...
const unsigned int GRP_SHOULDER_BOOM	=	10;	//SHOULDER_BOOM
