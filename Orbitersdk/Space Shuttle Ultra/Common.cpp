...
double SRB_Thrust[SRB_nt] = {                0.000, 0.000,0.955,0.971,0.992,0.988,1.000,0.915,0.856,0.810,0.779,0.750,0.705,0.721,0.735,0.757,0.764,0.765,0.765,0.691,0.647,0.629,0.587,0.513,0.440,0.220,0.044,0.023,0.010,0.000};
...
PARTICLESTREAMSPEC srb_exhaust = {//DaveS edit: Modified SRB exhaust PSTREAM to be more realistic
	0, 3.5, 5000, 100.0, 0.0, 1, 30, 0.0, PARTICLESTREAMSPEC::EMISSIVE,
...
PARTICLESTREAMSPEC bsm_exhaust = {//DaveS edit: Modified SRB exhaust PSTREAM to be more realistic
	0, 1.2, 5000, 70.0, 0.1, 0.2, 4, 3.0, PARTICLESTREAMSPEC::EMISSIVE,
	PARTICLESTREAMSPEC::LVL_FLAT, 1, 1,
	PARTICLESTREAMSPEC::ATM_FLAT, 1, 1
};
