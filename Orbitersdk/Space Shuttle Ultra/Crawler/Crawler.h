...
const double JACKING_HEIGHTS[JACK_HEIGHT_COUNT] = {0.0, 0.702, 1.4};
...
const double LC39_RAMP_START = 392.0; // distance from pad at which ramp starts
const double LC39_RAMP_END = 129.5; // distance from pad at which ramp ends
...
private:
	...
	double CalcRampHeight(double dist) { return range(0.0, (LC39_RAMP_START-dist)*(15.45 / (LC39_RAMP_START - LC39_RAMP_END)), 15.45); };
