...
template <class TVessel>
void BasicVCComponent<TVessel>::OnPreStep(double fSimT, double fDeltaT, double fMJD)
{

}

template <class TVessel>
void BasicVCComponent<TVessel>::OnPostStep(double fSimT, double fDeltaT, double fMJD)
{

}

template <class TVessel>
void BasicVCComponent<TVessel>::OnPropagate(double fSimT, double fDeltaT, double fMJD)
{
...
template <class TVessel>
void BasicVCComponent<TVessel>::OnPlaybackEvent(double fSimT, double fEventT, const char* event_t, const char* event)
{
}
