...
The flight instrument displays are only partially implemented. All displays in the Ascent/Entry Primary Flight Display are working except for the ADI and HSI. The Orbit Primary Flight Display is not implemented.
\end{multicols*}
