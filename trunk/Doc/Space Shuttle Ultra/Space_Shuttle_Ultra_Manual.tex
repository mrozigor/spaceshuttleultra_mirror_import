...
$\rightarrow$ extensive overhaul of the CRTMFD displays: corrected MDU screen aspect ratio, all displays reworked and converted to 512x512 resolution, separate code for MOGE and D3D9, added fonts, improved resource allocation\\
$\rightarrow$ improved CRT keyboard data entry\\
$\rightarrow$ improved memory cleanup on exit\\
$\rightarrow$ updated 7-segment displays to the \"UV system\"\\
