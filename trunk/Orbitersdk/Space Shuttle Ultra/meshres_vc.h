...
// Date of conversion : Sun Aug 25 21:48:46 2013
...
const unsigned int GRP_C3COVER1_VC	=	106;	//C3cover1
const unsigned int GRP_C3COVER2_VC	=	107;	//C3cover2
const unsigned int GRP_C3COVER3_VC	=	108;	//C3cover3
const unsigned int GRP_C3COVER4_VC	=	109;	//C3cover4
const unsigned int GRP_C3COVER5_VC	=	110;	//C3cover5
const unsigned int GRP_C3_VC	=	111;	//C3
const unsigned int GRP_C3DIAL_VC	=	112;	//C3Dial
const unsigned int GRP_C3B1_VC	=	113;	//C3b1
const unsigned int GRP_C3B2_VC	=	114;	//C3b2
const unsigned int GRP_C3B3_VC	=	115;	//C3b3
const unsigned int GRP_C3B4_VC	=	116;	//C3b4
const unsigned int GRP_C3B5_VC	=	117;	//C3b5
const unsigned int GRP_C3B6_VC	=	118;	//C3b6
const unsigned int GRP_C3B7_VC	=	119;	//C3b7
const unsigned int GRP_C3B8_VC	=	120;	//C3b8
const unsigned int GRP_C3B9_VC	=	121;	//C3b9
const unsigned int GRP_C3B10_VC	=	122;	//C3b10
const unsigned int GRP_C3B11_VC	=	123;	//C3b11
const unsigned int GRP_C3B12_VC	=	124;	//C3b12
const unsigned int GRP_C3B13_VC	=	125;	//C3b13
const unsigned int GRP_C3B14V_VC	=	126;	//C3b14v
const unsigned int GRP_C3B15_VC	=	127;	//C3b15
const unsigned int GRP_C3B16_VC	=	128;	//C3b16
const unsigned int GRP_C3B17_VC	=	129;	//C3b17
const unsigned int GRP_C3B18V_VC	=	130;	//C3b18v
const unsigned int GRP_C3B19_VC	=	131;	//C3b19
const unsigned int GRP_C3B20_VC	=	132;	//C3b20
const unsigned int GRP_C3B21_VC	=	133;	//C3b21
const unsigned int GRP_C3B22_VC	=	134;	//C3b22
const unsigned int GRP_C3B23_VC	=	135;	//C3b23
const unsigned int GRP_C3B24_VC	=	136;	//C3b24
const unsigned int GRP_C3B25_VC	=	137;	//C3b25
const unsigned int GRP_C3B26_VC	=	138;	//C3b26
const unsigned int GRP_C3B27_VC	=	139;	//C3b27
const unsigned int GRP_C3B28_VC	=	140;	//C3b28
const unsigned int GRP_C3B29_VC	=	141;	//C3b29
const unsigned int GRP_C3B30_VC	=	142;	//C3b30
const unsigned int GRP_C3B31_VC	=	143;	//C3b31
const unsigned int GRP_C3B32_VC	=	144;	//C3b32
const unsigned int GRP_C3B33_VC	=	145;	//C3b33
const unsigned int GRP_C3B34_VC	=	146;	//C3b34
const unsigned int GRP_C3B35_VC	=	147;	//C3b35
const unsigned int GRP_C3B36_VC	=	148;	//C3b36
const unsigned int GRP_C3B37_VC	=	149;	//C3b37
const unsigned int GRP_O6GUARD_VC	=	150;	//O6Guard
const unsigned int GRP_O6PANEL_VC	=	151;	//O6panel
const unsigned int GRP_O6S50_VC	=	152;	//O6S50
const unsigned int GRP_O6S49_VC	=	153;	//O6S49
const unsigned int GRP_O6S48_VC	=	154;	//O6S48
const unsigned int GRP_O6S47_VC	=	155;	//O6S47
const unsigned int GRP_O6S46_VC	=	156;	//O6S46
const unsigned int GRP_O6S45_VC	=	157;	//O6S45
const unsigned int GRP_O6S28_VC	=	158;	//O6S28
const unsigned int GRP_O6S26_VC	=	159;	//O6S26
const unsigned int GRP_O6S29_VC	=	160;	//O6S29
const unsigned int GRP_O6S27_VC	=	161;	//O6S27
const unsigned int GRP_O6S25_VC	=	162;	//O6S25
const unsigned int GRP_O6S20_VC	=	163;	//O6S20
const unsigned int GRP_O6S22_VC	=	164;	//O6S22
const unsigned int GRP_O6S24_VC	=	165;	//O6S24
const unsigned int GRP_O6S21_VC	=	166;	//O6S21
const unsigned int GRP_O6S23_VC	=	167;	//O6S23
const unsigned int GRP_O6S18_VC	=	168;	//O6S18
const unsigned int GRP_O6S16_VC	=	169;	//O6S16
const unsigned int GRP_O6S19_VC	=	170;	//O6S19
const unsigned int GRP_O6S17_VC	=	171;	//O6S17
const unsigned int GRP_O6S52_VC	=	172;	//O6S52
const unsigned int GRP_O6R2_VC	=	173;	//O6R2
const unsigned int GRP_O6RS6_VC	=	174;	//O6RS6
const unsigned int GRP_O6R7_VC	=	175;	//O6R7
const unsigned int GRP_O6R1_VC	=	176;	//O6R1
const unsigned int GRP_O6R5_VC	=	177;	//O6R5
const unsigned int GRP_O6R6_VC	=	178;	//O6R6
const unsigned int GRP_O6R4_VC	=	179;	//O6R4
const unsigned int GRP_O6S35_VC	=	180;	//O6S35
const unsigned int GRP_O6S36_VC	=	181;	//O6S36
const unsigned int GRP_O6S37_VC	=	182;	//O6S37
const unsigned int GRP_O6S38_VC	=	183;	//O6S38
const unsigned int GRP_O6S39_VC	=	184;	//O6S39
const unsigned int GRP_O6S2_VC	=	185;	//O6S2
const unsigned int GRP_O6S3_VC	=	186;	//O6S3
const unsigned int GRP_O6S34_VC	=	187;	//O6S34
const unsigned int GRP_O6S33_VC	=	188;	//O6S33
const unsigned int GRP_O6S32_VC	=	189;	//O6S32
const unsigned int GRP_O6S31_VC	=	190;	//O6S31
const unsigned int GRP_O6S30_VC	=	191;	//O6S30
const unsigned int GRP_O6S15_VC	=	192;	//O6S15
const unsigned int GRP_O6S51_VC	=	193;	//O6S51
const unsigned int GRP_O6S14_VC	=	194;	//O6S14
const unsigned int GRP_O6S12_VC	=	195;	//O6S12
const unsigned int GRP_O6S13_VC	=	196;	//O6S13
const unsigned int GRP_O6S6_VC	=	197;	//O6S6
const unsigned int GRP_O6S1_VC	=	198;	//O6S1
const unsigned int GRP_O6S5_VC	=	199;	//O6S5
const unsigned int GRP_O6SWITCHA_VC	=	200;	//O6switchA
const unsigned int GRP_O6SWITCHB_VC	=	201;	//O6switchB
const unsigned int GRP_O6SWITCHC_VC	=	202;	//O6switchC
const unsigned int GRP_O6R3_VC	=	203;	//O6R3
const unsigned int GRP_O6S4_VC	=	204;	//O6S4
const unsigned int GRP_O7RS5_VC	=	205;	//O7RS5
const unsigned int GRP_O7RS3_VC	=	206;	//O7RS3
const unsigned int GRP_O7RS1_VC	=	207;	//O7RS1
const unsigned int GRP_O7S36_VC	=	208;	//O7S36
const unsigned int GRP_O7S35_VC	=	209;	//O7S35
const unsigned int GRP_O7S34_VC	=	210;	//O7S34
const unsigned int GRP_O7S33_VC	=	211;	//O7S33
const unsigned int GRP_O7S32_VC	=	212;	//O7S32
const unsigned int GRP_O7S27_VC	=	213;	//O7S27
const unsigned int GRP_O7S29_VC	=	214;	//O7S29
const unsigned int GRP_O7S30_VC	=	215;	//O7S30
const unsigned int GRP_O7S28_VC	=	216;	//O7S28
const unsigned int GRP_O7S31_VC	=	217;	//O7S31
const unsigned int GRP_O7S26_VC	=	218;	//O7S26
const unsigned int GRP_O7S23_VC	=	219;	//O7S23
const unsigned int GRP_O7S25_VC	=	220;	//O7S25
const unsigned int GRP_O7S24_VC	=	221;	//O7S24
const unsigned int GRP_O7S22_VC	=	222;	//O7S22
const unsigned int GRP_O7S16B_VC	=	223;	//O7S16b
const unsigned int GRP_O7S17B_VC	=	224;	//O7S17b
const unsigned int GRP_O7S18B_VC	=	225;	//O7S18b
const unsigned int GRP_O7S18A_VC	=	226;	//O7S18a
const unsigned int GRP_O7S17A_VC	=	227;	//O7S17a
const unsigned int GRP_O7S16A_VC	=	228;	//O7S16a
const unsigned int GRP_O7S14_VC	=	229;	//O7S14
const unsigned int GRP_O7S13_VC	=	230;	//O7S13
const unsigned int GRP_O7S11_VC	=	231;	//O7S11
const unsigned int GRP_O7S10_VC	=	232;	//O7S10
const unsigned int GRP_O7S6_VC	=	233;	//O7S6
const unsigned int GRP_O7S4_VC	=	234;	//O7S4
const unsigned int GRP_O7S2_VC	=	235;	//O7S2
const unsigned int GRP_O7PANEL_VC	=	236;	//O7panel
const unsigned int GRP_O7GUARD_VC	=	237;	//O7Guard
const unsigned int GRP_O8GUARD_VC	=	238;	//O8Guard
const unsigned int GRP_O8S33_VC	=	239;	//O8S33
const unsigned int GRP_O8S31_VC	=	240;	//O8S31
const unsigned int GRP_O8S30_VC	=	241;	//O8S30
const unsigned int GRP_O8S34_VC	=	242;	//O8S34
const unsigned int GRP_O8S32_VC	=	243;	//O8S32
const unsigned int GRP_O8S28_VC	=	244;	//O8S28
const unsigned int GRP_O8S26_VC	=	245;	//O8S26
const unsigned int GRP_O8S27_VC	=	246;	//O8S27
const unsigned int GRP_O8S29_VC	=	247;	//O8S29
const unsigned int GRP_O8S22_VC	=	248;	//O8S22
const unsigned int GRP_O8S20_VC	=	249;	//O8S20
const unsigned int GRP_O8S7_VC	=	250;	//O8S7
const unsigned int GRP_O8S6_VC	=	251;	//O8S6
const unsigned int GRP_O8S19_VC	=	252;	//O8S19
const unsigned int GRP_O8S21_VC	=	253;	//O8S21
const unsigned int GRP_O8S23_VC	=	254;	//O8S23
const unsigned int GRP_O8S24_VC	=	255;	//O8S24
const unsigned int GRP_O8S16_VC	=	256;	//O8S16
const unsigned int GRP_O8S17_VC	=	257;	//O8S17
const unsigned int GRP_O8S15_VC	=	258;	//O8S15
const unsigned int GRP_O8S13_VC	=	259;	//O8S13
const unsigned int GRP_O8S2A_VC	=	260;	//O8S2a
const unsigned int GRP_O8S1A_VC	=	261;	//O8S1a
const unsigned int GRP_O8S12_VC	=	262;	//O8S12
const unsigned int GRP_O8S14_VC	=	263;	//O8S14
const unsigned int GRP_O8S18_VC	=	264;	//O8S18
const unsigned int GRP_O8R6_VC	=	265;	//O8R6
const unsigned int GRP_O8S1_VC	=	266;	//O8S1
const unsigned int GRP_O8S3_VC	=	267;	//O8S3
const unsigned int GRP_O8S10_VC	=	268;	//O8S10
const unsigned int GRP_O8S8_VC	=	269;	//O8S8
const unsigned int GRP_O8S9_VC	=	270;	//O8S9
const unsigned int GRP_O8R1_VC	=	271;	//O8R1
const unsigned int GRP_O8R4_VC	=	272;	//O8R4
const unsigned int GRP_O8R5_VC	=	273;	//O8R5
const unsigned int GRP_O8R3_VC	=	274;	//O8R3
const unsigned int GRP_O8S5_VC	=	275;	//O8S5
const unsigned int GRP_O8R2_VC	=	276;	//O8R2
const unsigned int GRP_O8S4_VC	=	277;	//O8S4
const unsigned int GRP_O8PANEL_VC	=	278;	//O8panel
const unsigned int GRP_O6SCOVER1_VC	=	279;	//O6Scover1
const unsigned int GRP_O6SCOVER2_VC	=	280;	//O6Scover2
const unsigned int GRP_O6SCOVER3_VC	=	281;	//O6Scover3
const unsigned int GRP_O6SCOVER4_VC	=	282;	//O6Scover4
const unsigned int GRP_O6SCOVER5_VC	=	283;	//O6Scover5
const unsigned int GRP_O6SCOVER10_VC	=	284;	//O6Scover10
const unsigned int GRP_O6SCOVER9_VC	=	285;	//O6Scover9
const unsigned int GRP_O6SCOVER8_VC	=	286;	//O6Scover8
const unsigned int GRP_O6SCOVER7_VC	=	287;	//O6Scover7
const unsigned int GRP_O6SCOVER6_VC	=	288;	//O6Scover6
const unsigned int GRP_O6SCOVER11_VC	=	289;	//O6Scover11
const unsigned int GRP_O6SCOVER12_VC	=	290;	//O6Scover12
const unsigned int GRP_O6GUARDA_VC	=	291;	//O6Guard
const unsigned int GRP_O6GUARDB_VC	=	292;	//O6Guard
const unsigned int GRP_A2PANEL_VC	=	293;	//A2panel
const unsigned int GRP_A2U1_VC	=	294;	//A2U1
const unsigned int GRP_A2U2_VC	=	295;	//A2U2
const unsigned int GRP_TRANSGUARD_VC	=	296;	//transguard
const unsigned int GRP_A6UGUARDB_VC	=	297;	//A6UGuardb
const unsigned int GRP_TRANSRMS_VC	=	298;	//transRMS
const unsigned int GRP_TRANSRMSBOOT_VC	=	299;	//transRMSboot
const unsigned int GRP_A2AZH_VC	=	300;	//A2AZH
const unsigned int GRP_A2ELH_VC	=	301;	//A2ELH
const unsigned int GRP_A2ELV_VC	=	302;	//A2ELV
const unsigned int GRP_A2AZV_VC	=	303;	//A2AZV
const unsigned int GRP_GUARDB_VC	=	304;	//Guardb
const unsigned int GRP_A4MISSIONSWITCH_VC	=	305;	//A4MissionSwitch
const unsigned int GRP_A4_EVENT_S_VC	=	306;	//A4_Event_S
const unsigned int GRP_A4_EVENT_S10_VC	=	307;	//A4_Event_S10
const unsigned int GRP_A4_EVENT_M_VC	=	308;	//A4_Event_M
const unsigned int GRP_A4_EVENT_M10_VC	=	309;	//A4_Event_M10
const unsigned int GRP_A4_MET_S2_VC	=	310;	//A4_MET_S2
const unsigned int GRP_A4_MET_S1_VC	=	311;	//A4_MET_S1
const unsigned int GRP_A4_MET_M2_VC	=	312;	//A4_MET_M2
const unsigned int GRP_A4_MET_M1_VC	=	313;	//A4_MET_M1
const unsigned int GRP_A4_MET_H2_VC	=	314;	//A4_MET_H2
const unsigned int GRP_A4_MET_H1_VC	=	315;	//A4_MET_H1
const unsigned int GRP_A4_MET_DAY3_VC	=	316;	//A4_MET_DAY3
const unsigned int GRP_A4_MET_DAY2_VC	=	317;	//A4_MET_DAY2
const unsigned int GRP_A4_MET_DAY1_VC	=	318;	//A4_MET_DAY1
const unsigned int GRP_PANELA4_VC	=	319;	//panelA4
const unsigned int GRP_A7U13_VC	=	320;	//A7U13
const unsigned int GRP_A7U9_VC	=	321;	//A7U9
const unsigned int GRP_A7U10_VC	=	322;	//A7U10
const unsigned int GRP_A7U53_VC	=	323;	//A7U53
const unsigned int GRP_A7U54_VC	=	324;	//A7U54
const unsigned int GRP_A7U8_VC	=	325;	//A7U8
const unsigned int GRP_A7U7_VC	=	326;	//A7U7
const unsigned int GRP_A7U5_VC	=	327;	//A7U5
const unsigned int GRP_A7U6_VC	=	328;	//A7U6
const unsigned int GRP_A7U4_VC	=	329;	//A7U4
const unsigned int GRP_A7U3_VC	=	330;	//A7U3
const unsigned int GRP_A7U1_VC	=	331;	//A7U1
const unsigned int GRP_A7U2_VC	=	332;	//A7U2
const unsigned int GRP_A7U14_VC	=	333;	//A7U14
const unsigned int GRP_A7U15_VC	=	334;	//A7U15
const unsigned int GRP_A7U17_VC	=	335;	//A7U17
const unsigned int GRP_A7U16_VC	=	336;	//A7U16
const unsigned int GRP_A7U18_VC	=	337;	//A7U18
const unsigned int GRP_A7U12_VC	=	338;	//A7U12
const unsigned int GRP_A7U52_VC	=	339;	//A7U52
const unsigned int GRP_A7U41_VC	=	340;	//A7U41
const unsigned int GRP_A7U42_VC	=	341;	//A7U42
const unsigned int GRP_A7U40_VC	=	342;	//A7U40
const unsigned int GRP_A7U56_VC	=	343;	//A7U56
const unsigned int GRP_A7U43_VC	=	344;	//A7U43
const unsigned int GRP_A7U44_VC	=	345;	//A7U44
const unsigned int GRP_A7U11_VC	=	346;	//A7U11
const unsigned int GRP_A7U_PANEL_VC	=	347;	//A7U_panel
const unsigned int GRP_A6UGUARDBA_VC	=	348;	//A6UGuardb
const unsigned int GRP_F6PANEL_VC	=	349;	//F6panel
const unsigned int GRP_F6PANEL1_VC	=	350;	//F6panel1
const unsigned int GRP_F6GUARD_VC	=	351;	//F6Guard
const unsigned int GRP_F6TALKBACK3_VC	=	352;	//F6TalkBack3
const unsigned int GRP_F6TALKBACK2_VC	=	353;	//F6TalkBack2
const unsigned int GRP_F6TALKBACK1_VC	=	354;	//F6TalkBack1
const unsigned int GRP_F6DIAL_VC	=	355;	//F6Dial
const unsigned int GRP_F6SWITCH_9_VC	=	356;	//F6switch_9
const unsigned int GRP_F6SWITCH_8_VC	=	357;	//F6switch_8
const unsigned int GRP_F6SWITCH_7_VC	=	358;	//F6switch_7
const unsigned int GRP_F6SWITCH_6_VC	=	359;	//F6switch_6
const unsigned int GRP_F6SWITCH_5_VC	=	360;	//F6switch_5
const unsigned int GRP_F6SWITCH_4_VC	=	361;	//F6switch_4
const unsigned int GRP_F6SWITCH_3_VC	=	362;	//F6switch_3
const unsigned int GRP_F6SWITCH_2_VC	=	363;	//F6switch_2
const unsigned int GRP_F6SWITCH_1_VC	=	364;	//F6switch_1
const unsigned int GRP_F6BUTTON7_VC	=	365;	//F6button7
const unsigned int GRP_F6BUTTON5_VC	=	366;	//F6button5
const unsigned int GRP_F6BUTTON4_VC	=	367;	//F6button4
const unsigned int GRP_F6BUTTON6_VC	=	368;	//F6button6
const unsigned int GRP_F6BUTTON3_VC	=	369;	//F6button3
const unsigned int GRP_F6BUTTON2_VC	=	370;	//F6button2
const unsigned int GRP_F6BUTTON1_VC	=	371;	//F6button1
const unsigned int GRP_F6COVER2_VC	=	372;	//F6cover2
const unsigned int GRP_F6COVER1_VC	=	373;	//F6cover1
const unsigned int GRP_F8PAN1_VC	=	374;	//F8pan1
const unsigned int GRP_F8GUARD_VC	=	375;	//F8Guard
const unsigned int GRP_F8SWITCH9_VC	=	376;	//F8switch9
const unsigned int GRP_F8SWITCH6_VC	=	377;	//F8switch6
const unsigned int GRP_F8SWITCH8_VC	=	378;	//F8switch8
const unsigned int GRP_F8SWITCH7_VC	=	379;	//F8switch7
const unsigned int GRP_F8SWITCH3_VC	=	380;	//F8switch3
const unsigned int GRP_F8SWITCH2_VC	=	381;	//F8switch2
const unsigned int GRP_F8SWITCH1_VC	=	382;	//F8switch1
const unsigned int GRP_F8SWITCH5_VC	=	383;	//F8switch5
const unsigned int GRP_F8SWITCH4_VC	=	384;	//F8switch4
const unsigned int GRP_F8TALKBACK1_VC	=	385;	//F8TalkBack1
const unsigned int GRP_F8TALKBACK2_VC	=	386;	//F8TalkBack2
const unsigned int GRP_F8TALKBACK3_VC	=	387;	//F8TalkBack3
const unsigned int GRP_F8BUTTON1_VC	=	388;	//F8button1
const unsigned int GRP_F8BUTTON2_VC	=	389;	//F8button2
const unsigned int GRP_F8BUTTON3_VC	=	390;	//F8button3
const unsigned int GRP_F8COVER1_VC	=	391;	//F8cover1
const unsigned int GRP_F8COVER2_VC	=	392;	//F8cover2
const unsigned int GRP_F8HUDBRT_VC	=	393;	//F8HUDbrt
const unsigned int GRP_F8HUDTEST_VC	=	394;	//F8HUDtest
const unsigned int GRP_F8HUDDIM_VC	=	395;	//F8HUDdim
const unsigned int GRP_F3S6_VC	=	396;	//F3S6
const unsigned int GRP_F3S4_VC	=	397;	//F3S4
const unsigned int GRP_F3S5_VC	=	398;	//F3S5
const unsigned int GRP_F3S2_VC	=	399;	//F3S2
const unsigned int GRP_F3S1_VC	=	400;	//F3S1
const unsigned int GRP_F3S3_VC	=	401;	//F3S3
const unsigned int GRP_F6HUDDIM_VC	=	402;	//F6HUDdim
const unsigned int GRP_F6HUDTEST_VC	=	403;	//F6HUDtest
const unsigned int GRP_F6HUDBRT_VC	=	404;	//F6HUDbrt
const unsigned int GRP_F8PANEL_VC	=	405;	//F8panel
const unsigned int GRP_F6GUARDA_VC	=	406;	//F6Guard
const unsigned int GRP_FCOVERS_VC	=	407;	//Fcovers
