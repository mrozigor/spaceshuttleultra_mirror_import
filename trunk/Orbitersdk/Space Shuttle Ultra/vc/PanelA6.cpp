...
namespace vc
{
	...
	void PanelA6::RegisterVC()
	{
		...
		//B
		oapiVCRegisterArea(AID_A6_PBI2, _R(777, 1178, 814, 1189), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//AUTO
		oapiVCRegisterArea(AID_A6_PBI3, _R(857, 1178, 894, 1189), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//INRTL
		oapiVCRegisterArea(AID_A6_PBI4, _R(936, 1180, 973, 1191), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//LVLH
		oapiVCRegisterArea(AID_A6_PBI5, _R(1014, 1180, 1051, 1191), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//FREE
		oapiVCRegisterArea(AID_A6_PBI6, _R(1094, 1181, 1131, 1192), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS X
		...
		//PRI
		oapiVCRegisterArea(AID_A6_PBI10, _R(945, 1340, 982, 1351), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ALT
		oapiVCRegisterArea(AID_A6_PBI11, _R(1025, 1340, 1062, 1351), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//VERN
		oapiVCRegisterArea(AID_A6_PBI12, _R(1102, 1340, 1139, 1351), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS X NORM
		//oapiVCRegisterArea(AID_A6_PBI13, _R(156, 1186, 198, 1200), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS Y NORM
		//oapiVCRegisterArea(AID_A6_PBI14, _R(249, 1186, 291, 1200), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS Z NORM
		//oapiVCRegisterArea(AID_A6_PBI15, _R(338, 1187, 380, 1201), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT ROLL DISC RATE
		//oapiVCRegisterArea(AID_A6_PBI16, _R(439, 1186, 481, 1200), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT PITCH DISC RATE
		//oapiVCRegisterArea(AID_A6_PBI17, _R(530, 1185, 572, 1199), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT YAW DISC RATE
		//oapiVCRegisterArea(AID_A6_PBI18, _R(624, 1185, 666, 1199), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS X PULSE
		//oapiVCRegisterArea(AID_A6_PBI19, _R(158, 1284, 200, 1298), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS Y PULSE
		//oapiVCRegisterArea(AID_A6_PBI20, _R(249, 1284, 291, 1298), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//TRANS Z PULSE
		//oapiVCRegisterArea(AID_A6_PBI21, _R(339, 1285, 381, 1299), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT ROLL PULSE
		//oapiVCRegisterArea(AID_A6_PBI22, _R(441, 1284, 483, 1298), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT PITCH PULSE
		//oapiVCRegisterArea(AID_A6_PBI23, _R(531, 1285, 573, 1299), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
		//ROT YAW PULSE
		//oapiVCRegisterArea(AID_A6_PBI24, _R(624, 1285, 666, 1299), PANEL_REDRAW_USER, PANEL_MOUSE_IGNORE, PANEL_MAP_NONE, panela6_tex);
	}
