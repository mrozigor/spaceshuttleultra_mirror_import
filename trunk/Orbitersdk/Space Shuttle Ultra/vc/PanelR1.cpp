...
namespace vc
{
	...
	{
		hPanelMesh = oapiLoadMeshGlobal( DEFAULT_MESHNAME_PANELR1 );
	...
	void PanelR1::AddMeshes( const VECTOR3 &ofs )
	{
		SetHasOwnVCMesh();
	...
	void PanelR1::SetMeshVisibility( bool visible )
	{
	...
	UINT PanelR1::GetVCMeshIndex( void ) const
	{
		return mesh_index;
	}
	...
	void PanelR1::DefineVC( void )
	{
		...
		pFCMainBusATB->DefineMeshGroups( mesh_index, GRP_A1_DS1_U_R1_VC, GRP_A1_DS1_L_R1_VC );
		pFCMainBusATB->SetInactiveSegment( TB_OFF );

		pFCMainBusBTB->DefineMeshGroups( mesh_index, GRP_A1_DS3_U_R1_VC, GRP_A1_DS3_L_R1_VC );
		pFCMainBusBTB->SetInactiveSegment( TB_OFF );

		pFCMainBusCTB->DefineMeshGroups( mesh_index, GRP_A1_DS5_U_R1_VC, GRP_A1_DS5_L_R1_VC );
		pFCMainBusCTB->SetInactiveSegment( TB_OFF );

		pMNBusTieATB->DefineMeshGroups( mesh_index, GRP_A1_DS2_U_R1_VC, GRP_A1_DS2_L_R1_VC );
		pMNBusTieATB->SetInactiveSegment( TB_OFF );

		pMNBusTieBTB->DefineMeshGroups( mesh_index, GRP_A1_DS4_U_R1_VC, GRP_A1_DS4_L_R1_VC );
		pMNBusTieBTB->SetInactiveSegment( TB_OFF );

		pMNBusTieCTB->DefineMeshGroups( mesh_index, GRP_A1_DS6_U_R1_VC, GRP_A1_DS6_L_R1_VC );
		pMNBusTieCTB->SetInactiveSegment( TB_OFF );

		pInvPwr1TB->DefineMeshGroups( mesh_index, GRP_A1_DS7_U_R1_VC, GRP_A1_DS7_L_R1_VC );
		pInvPwr1TB->SetInactiveSegment( TB_ON );

		pInvPwr2TB->DefineMeshGroups( mesh_index, GRP_A1_DS9_U_R1_VC, GRP_A1_DS9_L_R1_VC );
		pInvPwr2TB->SetInactiveSegment( TB_ON );

		pInvPwr3TB->DefineMeshGroups( mesh_index, GRP_A1_DS11_U_R1_VC, GRP_A1_DS11_L_R1_VC );
		pInvPwr3TB->SetInactiveSegment( TB_ON );

		pInvACBus1TB->DefineMeshGroups( mesh_index, GRP_A1_DS8_U_R1_VC, GRP_A1_DS8_L_R1_VC );
		pInvACBus1TB->SetInactiveSegment( TB_OFF );

		pInvACBus2TB->DefineMeshGroups( mesh_index, GRP_A1_DS10_U_R1_VC, GRP_A1_DS10_L_R1_VC );
		pInvACBus2TB->SetInactiveSegment( TB_OFF );

		pInvACBus3TB->DefineMeshGroups( mesh_index, GRP_A1_DS12_U_R1_VC, GRP_A1_DS12_L_R1_VC );
		pInvACBus3TB->SetInactiveSegment( TB_OFF );

		pPayloadPriMNBTB->DefineMeshGroups( mesh_index, GRP_A1_DS15_U_R1_VC, GRP_A1_DS15_L_R1_VC );
		pPayloadPriMNBTB->SetInactiveSegment( TB_OFF );

		pPayloadPriFC3TB->DefineMeshGroups( mesh_index, GRP_A1_DS16_U_R1_VC, GRP_A1_DS16_L_R1_VC );
		pPayloadPriFC3TB->SetInactiveSegment( TB_OFF );

		pPayloadPriMNCTB->DefineMeshGroups( mesh_index, GRP_A1_DS17_U_R1_VC, GRP_A1_DS17_L_R1_VC );
		pPayloadPriMNCTB->SetInactiveSegment( TB_OFF );

		pFuelCell1ReacO2->DefineMeshGroups( mesh_index, GRP_A2_DS1_U_R1_VC, GRP_A2_DS1_L_R1_VC );
		pFuelCell1ReacO2->SetInactiveSegment( TB_CL );

		pFuelCell2ReacO2->DefineMeshGroups( mesh_index, GRP_A2_DS9_U_R1_VC, GRP_A2_DS9_L_R1_VC );
		pFuelCell2ReacO2->SetInactiveSegment( TB_CL );

		pFuelCell3ReacO2->DefineMeshGroups( mesh_index, GRP_A2_DS5_U_R1_VC, GRP_A2_DS5_L_R1_VC );
		pFuelCell3ReacO2->SetInactiveSegment( TB_CL );

		pFuelCell1ReacH2->DefineMeshGroups( mesh_index, GRP_A2_DS2_U_R1_VC, GRP_A2_DS2_L_R1_VC );
		pFuelCell1ReacH2->SetInactiveSegment( TB_CL );

		pFuelCell2ReacH2->DefineMeshGroups( mesh_index, GRP_A2_DS10_U_R1_VC, GRP_A2_DS10_L_R1_VC );
		pFuelCell2ReacH2->SetInactiveSegment( TB_CL );

		pFuelCell3ReacH2->DefineMeshGroups( mesh_index, GRP_A2_DS6_U_R1_VC, GRP_A2_DS6_L_R1_VC );
		pFuelCell3ReacH2->SetInactiveSegment( TB_CL );

		pO2ManifoldVlvTank1TB->DefineMeshGroups( mesh_index, GRP_A2_DS3_U_R1_VC, GRP_A2_DS3_L_R1_VC );
		pO2ManifoldVlvTank1TB->SetInactiveSegment( TB_CL );

		pO2ManifoldVlvTank2TB->DefineMeshGroups( mesh_index, GRP_A2_DS7_U_R1_VC, GRP_A2_DS7_L_R1_VC );
		pO2ManifoldVlvTank2TB->SetInactiveSegment( TB_CL );

		pH2ManifoldVlvTank1TB->DefineMeshGroups( mesh_index, GRP_A2_DS4_U_R1_VC, GRP_A2_DS4_L_R1_VC );
		pH2ManifoldVlvTank1TB->SetInactiveSegment( TB_CL );

		pH2ManifoldVlvTank2TB->DefineMeshGroups( mesh_index, GRP_A2_DS8_U_R1_VC, GRP_A2_DS8_L_R1_VC );
		pH2ManifoldVlvTank2TB->SetInactiveSegment( TB_CL );

		pFuelCellReadyForLoad1->DefineMeshGroups( mesh_index, GRP_A2_DS11_U_R1_VC, GRP_A2_DS11_L_R1_VC );

		pFuelCellReadyForLoad2->DefineMeshGroups( mesh_index, GRP_A2_DS12_U_R1_VC, GRP_A2_DS12_L_R1_VC );

		pFuelCellReadyForLoad3->DefineMeshGroups( mesh_index, GRP_A2_DS13_U_R1_VC, GRP_A2_DS13_L_R1_VC );

		pFuelCellCoolantPumpdP1->DefineMeshGroups( mesh_index, GRP_A2_DS14_U_R1_VC, GRP_A2_DS14_L_R1_VC );

		pFuelCellCoolantPumpdP2->DefineMeshGroups( mesh_index, GRP_A2_DS15_U_R1_VC, GRP_A2_DS15_L_R1_VC );

		pFuelCellCoolantPumpdP3->DefineMeshGroups( mesh_index, GRP_A2_DS16_U_R1_VC, GRP_A2_DS16_L_R1_VC );
		return;
	}
	...
	void PanelR1::DefineVCAnimations( UINT vcidx )
	{
