...
void Atlantis::CreateAttControls_Launch()
{
	...
	th_rot[0] = CreateThruster (_V(0,0, 25), _V(0, 1,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(0,0,-25), _V(0,-1,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_PITCHUP);
	th_rot[0] = CreateThruster (_V(0,0, 25), _V(0,-1,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(0,0,-25), _V(0, 1,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_PITCHDOWN);
	th_rot[0] = CreateThruster (_V( 8,0,0), _V(0, 1,0), MAX_ROLL_SRB, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(-8,0,0), _V(0,-1,0), MAX_ROLL_SRB, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_BANKLEFT);
	th_rot[0] = CreateThruster (_V( 8,0,0), _V(0,-1,0), MAX_ROLL_SRB, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(-8,0,0), _V(0, 1,0), MAX_ROLL_SRB, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_BANKRIGHT);
	th_rot[0] = CreateThruster (_V(0,0, 10), _V( 1,0,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(0,0,-10), _V(-1,0,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_YAWRIGHT);
	th_rot[0] = CreateThruster (_V(0,0, 10), _V(-1,0,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	th_rot[1] = CreateThruster (_V(0,0,-10), _V( 1,0,0), MAX_ATT_LAUNCH, ph_tank, ORBITER_MAIN_ISP0, ORBITER_MAIN_ISP1);
	CreateThrusterGroup (th_rot, 2, THGROUP_ATT_YAWLEFT);
}
...
bool Atlantis::clbkPlaybackEvent (double simt, double event_t, const char *event_type, const char *event)
{
	if (!stricmp (event_type, "JET")) {
		...
		OperateLandingGear (!stricmp (event, "UP") ? AnimState::CLOSING : AnimState::OPENING);
		return true;
