...
const VECTOR3 CISS_G_P2 = _V( 0, 1.1647, -2.3245 );// motor crank rotation axis
const VECTOR3 CISS_G_P3 = _V( 0, 1.0752, -2.7867 );// motor crank/link rotation axis
const VECTOR3 CISS_G_P4 = _V( 0, 0.7773, -3.3501 );// link rotation axis
const VECTOR3 CISS_G_P5 = _V( 0, 0.7569, -1.55351 );// LOX first bellow (from disconnect)
const VECTOR3 CISS_G_P6 = _V( 0, 0.7568, -2.2178 );// LOX second bellow (from disconnect)
const VECTOR3 CISS_G_P7 = _V( 0, -0.8704, -2.2048 );// LOX third bellow (from disconnect)
const VECTOR3 CISS_G_P8 = _V( 0, 0.5720, -1.55341 );// GOX first bellow (from disconnect)
...
const VECTOR3 CISS_G_P11 = _V( 0, 0.7569, -1.55351 );// LH2 first bellow (from disconnect)
const VECTOR3 CISS_G_P12 = _V( 0, 0.7569, -2.2178 );// LH2 second bellow (from disconnect)
const VECTOR3 CISS_G_P13 = _V( 0, -0.8705, -2.2044 );// LH2 third bellow (from disconnect)
const VECTOR3 CISS_G_P14 = _V( 0, 0.5708, -1.55341 );// GH2 first bellow (from disconnect)
...
const VECTOR3 CISS_GPRIME_P2 = _V( 0, 1.1647, -2.3245 );// motor crank rotation axis
const VECTOR3 CISS_GPRIME_P3 = _V( 0, 1.0752, -2.7867 );// motor crank/link rotation axis
const VECTOR3 CISS_GPRIME_P4 = _V( 0, 0.7773, -3.3501 );// link rotation axis
const VECTOR3 CISS_GPRIME_P5 = _V( 0, 0.7569, -1.55351 );// LOX first bellow (from disconnect)
...
const VECTOR3 CISS_GPRIME_P8 = _V( 0, 0.5720, -1.55341 );// GOX first bellow (from disconnect)
...
const VECTOR3 CISS_GPRIME_P11 = _V( 0, 0.7569, -1.55351 );// LH2 first bellow (from disconnect)
...
const VECTOR3 CISS_GPRIME_P14 = _V( 0, 0.5708, -1.55341 );// GH2 first bellow (from disconnect)
