...
namespace vc
{
	...
	void PanelR2::DefineVC()
	{
		...
		/**** ET Umbilical Doors ****/
		pCenterlineLatch->SetMouseRegion( AID_R2, 0.193928f, 0.884566f, 0.253453f, 0.916514f);
		...
		pLeftUmbDoor->SetMouseRegion( AID_R2, 0.292763f, 0.885751f, 0.351700f, 0.920420f);
		...
		pLeftUmbDoorLatch->SetMouseRegion( AID_R2, 0.375219f, 0.887672f, 0.433632f, 0.922404f);
		...
		pRightUmbDoor->SetMouseRegion( AID_R2, 0.455335f, 0.889641f, 0.513106f, 0.923580f);
		...
		pRightUmbDoorLatch->SetMouseRegion( AID_R2, 0.53287f, 0.890511f, 0.590665f, 0.925481f);
