...
namespace vc
{
	...
	void PanelA7U::DefineVC()
	{
		...
		pMasterAlarm->SetMouseRegion( AID_A7U, 0.860198f, 0.080638f, 0.916229f, 0.133652f );
		...
		pVideoInputA->SetMouseRegion( AID_A7U, 0.449159f, 0.393826f, 0.491246f, 0.448441f );
		...
		pVideoInputB->SetMouseRegion( AID_A7U, 0.393562f, 0.393563f, 0.435272f, 0.448867f );
		...
		pVideoInputC->SetMouseRegion( AID_A7U, 0.338530f, 0.394243f, 0.380856f, 0.448831f );
		...
		pVideoInputD->SetMouseRegion( AID_A7U, 0.449167f, 0.472623f, 0.491354f, 0.527204f );
		...
		pVideoInputRMS->SetMouseRegion( AID_A7U, 0.393252f, 0.472663f, 0.435020f, 0.527389f );
		...
		pVideoInputFltDeck->SetMouseRegion( AID_A7U, 0.338498f, 0.473108f, 0.380514f, 0.527508f );
		...
		pVideoInputMidDeck->SetMouseRegion( AID_A7U, 0.283088f, 0.472665f, 0.325025f, 0.526744f );
		...
		pVideoInputPL1->SetMouseRegion( AID_A7U, 0.449259f, 0.564221f, 0.491032f, 0.618662f );
		...
		pVideoInputPL2->SetMouseRegion( AID_A7U, 0.392937f, 0.563183f, 0.435327f, 0.619063f );
		...
		pVideoInputPL3->SetMouseRegion( AID_A7U, 0.337886f, 0.563028f, 0.380877f, 0.618987f );
		...
		pVideoInputMUX1->SetMouseRegion( AID_A7U, 0.448892f, 0.641357f, 0.490923f, 0.695677f );
		...
		pVideoInputMUX2->SetMouseRegion( AID_A7U, 0.393810f, 0.642569f, 0.434115f, 0.696355f );
		...
		pVideoInputTest->SetMouseRegion( AID_A7U, 0.338595f, 0.641467f, 0.379875f, 0.695877f );
		...
		pVideoOutputMon1->SetMouseRegion( AID_A7U, 0.155487f, 0.394234f, 0.197079f, 0.448819f );
		...
		pVideoOutputMon2->SetMouseRegion( AID_A7U, 0.155040f, 0.472985f, 0.197537f, 0.527201f );
		...
		pVideoOutputDownLink->SetMouseRegion( AID_A7U, 0.099781f, 0.394072f, 0.141733f, 0.448912f );
		...
		pVideoOutputDTV->SetMouseRegion( AID_A7U, 0.099828f, 0.473221f, 0.141774f, 0.527048f );
		...
		pVideoOutputMUX1L->SetMouseRegion( AID_A7U, 0.155033f, 0.563973f, 0.197524f, 0.617812f );
		...
		pVideoOutputMUX1R->SetMouseRegion( AID_A7U, 0.098967f, 0.563465f, 0.141770f, 0.618104f );
		...
		pVideoOutputMUX2L->SetMouseRegion( AID_A7U, 0.155095f, 0.642404f, 0.197513f, 0.696950f );
		...
		pVideoOutputMUX2R->SetMouseRegion( AID_A7U, 0.099998f, 0.643432f, 0.141877f, 0.696410f );
		...
		pMenuALC->SetMouseRegion( AID_A7U, 0.365113f, 0.907374f, 0.407299f, 0.961727f );
		...
		pMenuManGain->SetMouseRegion( AID_A7U, 0.311151f, 0.908085f, 0.352909f, 0.962547f );
		...
		pMenuColorBalLTLevel->SetMouseRegion( AID_A7U, 0.257292f, 0.906941f, 0.299945f, 0.962167f );
		...
		pCameraPowerA->SetMouseRegion( AID_A7U, 0.449941f, 0.216160f, 0.489953f, 0.272383f );
		...
		pCameraPowerB->SetMouseRegion( AID_A7U, 0.393330f, 0.216516f, 0.432321f, 0.270997f );
		...
		pCameraPowerC->SetMouseRegion( AID_A7U, 0.337538f, 0.215611f, 0.380122f, 0.271418f );
		...
		pCameraPowerD->SetMouseRegion( AID_A7U, 0.285335f, 0.215972f, 0.322215f, 0.270588f );
		...
		pCameraPowerRMS->SetMouseRegion( AID_A7U, 0.226493f, 0.212685f, 0.269290f, 0.270410f );
		...
		pCameraPan->SetMouseRegion( AID_A7U, 0.099787f, 0.768763f, 0.153872f, 0.873155f);
		...
		pCameraTilt->SetMouseRegion( AID_A7U, 0.174297f, 0.773431f, 0.231700f, 0.856463f);
		...
		pPanTiltRate->SetMouseRegion( AID_A7U, 0.412282f, 0.769816f, 0.471316f, 0.868281f);
		...
		pRMSLight->SetMouseRegion( AID_A7U, 0.887903f, 0.839638f, 0.927633f, 0.892271f);
		...
		pDockingLight->SetMouseRegion( AID_A7U, 0.870177f, 0.691057f, 0.931207f, 0.773388f);
