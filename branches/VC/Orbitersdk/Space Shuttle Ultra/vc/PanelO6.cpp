...
namespace vc {
	...
	void PanelO6::DefineVC()
	{
		...
		pSTRKDoorControlSys1Cover->SetMouseRegion( AID_O6, 0, 0.656091f, 0.175973f, 0.700474f, 0.227679f );
		pSTRKDoorControlSys1Cover->SetMouseRegion( AID_O6, 1, 0.656091f, 0.236236f, 0.700474f, 0.251363f );
		...
		pSTRKDoorControlSys2Cover->SetMouseRegion( AID_O6, 0, 0.724671f, 0.175973f, 0.764189f, 0.227679f );
		pSTRKDoorControlSys2Cover->SetMouseRegion( AID_O6, 1, 0.724671f, 0.236236f, 0.764189f, 0.251363f );
		...
		pSTRKDoorControlSys1->SetMouseRegion( AID_O6, 0.64f, 0.1767f, 0.7078f, 0.2315f);
		...
		pSTRKDoorControlSys2->SetMouseRegion( AID_O6, 0.7267f, 0.1767f, 0.7706f, 0.2315f);
