...
const unsigned int NUMGRP_G = 67;

const unsigned int GRP_AFT_ADAPTER_G	=	0;	//AFT_ADAPTER
const unsigned int GRP_CABLEWAY_BOX_G	=	1;	//CABLEWAY_BOX
const unsigned int GRP_GH2_VENT_LINE_G	=	2;	//GH2_VENT_LINE
const unsigned int GRP_GHE_N2H3_BOTTLE_STRUTS_G	=	3;	//GHE_N2H3_BOTTLE_STRUTS
const unsigned int GRP_GHE_N2H3_BOTTLES_G	=	4;	//GHE_N2H3_BOTTLES
const unsigned int GRP_GOX_VENT_LINE_G	=	5;	//GOX_VENT_LINE
const unsigned int GRP_LENGINEBOXE_G	=	6;	//LEngineBoxe
const unsigned int GRP_LENGINENOZZ_G	=	7;	//LEngineNozz
const unsigned int GRP_LENGINEPUMP_G	=	8;	//LEnginePump
const unsigned int GRP_LENGINESILV_G	=	9;	//LEngineSilv
const unsigned int GRP_LH2_ENGINE_FEEDLINE_G	=	10;	//LH2_ENGINE_FEEDLINE
const unsigned int GRP_LH2_ENGINE_FEEDLINE_SHROUD_G	=	11;	//LH2_ENGINE_FEEDLINE_SHROUD
const unsigned int GRP_LH2_FILL_DRAIN_DUMP_LINE_G	=	12;	//LH2_FILL_DRAIN_DUMP_LINE
const unsigned int GRP_LH2_FILL_DRAIN_DUMP_LINE_SHROUD_G	=	13;	//LH2_FILL_DRAIN_DUMP_LINE_SHROUD
const unsigned int GRP_LOX_ENGINE_FEEDLINES_G	=	14;	//LOX_ENGINE_FEEDLINES
const unsigned int GRP_LOX_FILL_DRAIN_DUMP_LINE_G	=	15;	//LOX_FILL_DRAIN_DUMP_LINE
const unsigned int GRP_LOX_TANK_SUMP_G	=	16;	//LOX_TANK_SUMP
const unsigned int GRP_PROPELLANT_TANKS_G	=	17;	//PROPELLANT_TANKS
const unsigned int GRP_REM_BOXES_G	=	18;	//REM_BOXES
const unsigned int GRP_REM_NOZZLES_G	=	19;	//REM_NOZZLES
const unsigned int GRP_RENGINEBOXE_G	=	20;	//REngineBoxe
const unsigned int GRP_RENGINENOZZ_G	=	21;	//REngineNozz
const unsigned int GRP_RENGINEPUMP_G	=	22;	//REnginePump
const unsigned int GRP_RENGINESILV_G	=	23;	//REngineSilv
const unsigned int GRP_STAGING_DISCONNECTS_UMBILICALS_G	=	24;	//STAGING_DISCONNECTS_UMBILICALS
const unsigned int GRP_STAGING_DISCONNECTS_G	=	25;	//STAGING_DISCONNECTS
const unsigned int GRP_PROPELLANT_POPPET_VALVES_G	=	26;	//PROPELLANT_POPPET_VALVES
const unsigned int GRP_PROPELLANT_DISCONNECTS_G	=	27;	//PROPELLANT_DISCONNECTS
